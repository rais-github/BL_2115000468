...
public class Main {
    public static void main(String[] args) {
        ...
        Iterator<Department> deptIterator = university.getDepartments().iterator();
        while (deptIterator.hasNext()) {
            Department dept = deptIterator.next();
            System.out.println("Department: " + dept.getName());
            Iterator<Faculty> facultyIterator = dept.getFaculties().iterator();
